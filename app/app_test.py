# app_test.py - Version with mocked Odoo data for testing
import os
import io
import base64
import logging
...
# ---------------------------
# Mock Data - Simulating Odoo Database
# ---------------------------
MOCK_CLIENTES = [
    {
        'id': 1,
    ...
    },
    {
        ...
        'phone': '33-9876-5432',
        'street': 'Calle Independencia 567',
        'street2': 'Col. Americana',
        'city': 'Guadalajara',
        'zip': '44160',
        'email': 'compras@comercializadoraxyz.com'
    },
    {
        'id': 3,
        'name': 'Industrias del Bajío',
        'phone': '33-5555-1234',
        'street': 'Blvd. Marcelino García Barragán 890',
        'street2': '',
        'city': 'Zapopan',
        'zip': '45010',
        'email': 'contacto@industriasbajio.com'
    }
]

# Sample base64 image for testing (small transparent PNG)
SAMPLE_IMAGE_B64 = "iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAYAAAAfFcSJAAAADUlEQVR42mNkYPhfDwAChwGA60e6kgAAAABJRU5ErkJggg=="

MOCK_PRODUCTOS = [
    {
        'id': 1,
        'display_name': 'Contenedor Plástico 500ml - Transparente',
        'image_1920': SAMPLE_IMAGE_B64
    },
    {
        'id': 2,
        'display_name': 'Tapa Hermética para Contenedor - Azul',
        'image_1920': SAMPLE_IMAGE_B64
    },
    {
        'id': 3,
        'display_name': 'Bandeja Plástica Rectangular 30x20cm',
        'image_1920': None
    },
    {
        'id': 4,
        'display_name': 'Vaso Desechable 250ml - Pack 100 unidades',
        'image_1920': SAMPLE_IMAGE_B64
    }
]

# ---------------------------
# Mock functions replacing Odoo calls
# ---------------------------
@lru_cache(maxsize=1)
def fetch_clientes():
    """Devuelve lista de clientes mockeados."""
    logger.info("Usando datos mockeados de clientes")
    return MOCK_CLIENTES

@lru_cache(maxsize=1)
def fetch_productos():
    """Devuelve lista de productos mockeados."""
    logger.info("Usando datos mockeados de productos")
